...
export class Issue108<Args extends Named<Issue108Args>> extends Resource<Args> {}

// args can also be accessed on a resource if no generic is specified,
// but the args' values are all "unknown"
export class Issue108p2 extends Resource {}
const issue108p2a = {} as unknown as Issue108p2;

export const issue108p2b = issue108p2a.args.named?.foo;
